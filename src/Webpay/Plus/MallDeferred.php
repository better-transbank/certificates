...
final class MallDeferred
{
    ...
    public const COMMERCE_CODE = '597044444424';
    public const PRIVATE = CERTS_DIR.'/webpay/plus/mall-deferred.key';
    public const PUBLIC = CERTS_DIR.'/webpay/plus/mall-deferred.crt';
}
